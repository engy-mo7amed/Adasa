  ...
  categories: [
    {
      ...
      count: 3,
      color: "emerald",
      icon: "fa-solid fa-sun text-xl text-orange-500 group-hover:text-white transition-colors duration-300",
    },
    {
      name: "بورتريه",
      count: 3,
      color: "purple",
      icon: "fa-solid fa-user text-xl text-orange-500 group-hover:text-white transition-colors duration-300",
    },
    {
      name: "مناظر طبيعية",
      count: 2,
      color: "blue",
      icon: "fa-solid fa-mountain text-xl text-orange-500 group-hover:text-white transition-colors duration-300",
    },
    {
      name: "تقنيات",
      count: 5,
      color: "orange",
      icon: "fa-solid fa-sliders text-xl text-orange-500 group-hover:text-white transition-colors duration-300",
    },
    {
      name: "معدات",
      count: 3,
